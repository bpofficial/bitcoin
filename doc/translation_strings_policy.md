...
This document provides guidelines for internationalization of the Tangerine Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tangerine_en.ts` remains unchanged.
