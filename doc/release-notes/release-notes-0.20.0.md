...
- Instead of running `make` simply, you should instead run
  `TANGERINE_GENBUILD_NO_GIT=1 make`.
...
- Command line options prefixed with main/test/regtest network names like
  `-main.port=5113` `-test.server=1` previously were allowed but ignored. Now
...
- #17910 Remove double `LIBTANGERINE_SERVER` linking (fanquake)
...
- #18429 Remove double `LIBTANGERINE_SERVER` from bench-Makefile (brakmic)
...
- #18341 Replace remaining literal TNG with `CURRENCY_UNIT` (domob1812)
