...
tangerinecore.org and tangerine.org and compares them.
...
WORKINGDIR = "/tmp/tangerine_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://tangerinecore.org"
HOST2 = "https://tangerine.org"
VERSIONPREFIX = "tangerine-core-"
...
def main(args):
    ...
    if not success:
        print("tangerine.org failed to provide signature file, "
              "but tangerinecore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("tangerine.org and tangerinecore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Tangerine Core binary release "
