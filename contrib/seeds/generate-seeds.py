...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef TANGERINE_CHAINPARAMSSEEDS_H\n')
    g.write('#define TANGERINE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the tangerine network\n')
    ...
    g.write('#endif // TANGERINE_CHAINPARAMSSEEDS_H\n')
