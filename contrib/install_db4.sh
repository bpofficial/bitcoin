...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the tangerine repository."
  exit 1
fi
...
# See https://github.com/tangerine/tangerine/issues/16064
...
echo 'When compiling tangerined, run `./configure` in the following way:'
echo
