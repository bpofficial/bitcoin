# Bootstrappable Tangerine Core Builds

This directory contains the files necessary to perform bootstrappable Tangerine
Core builds.
...
From the top of a clean Tangerine Core repository:
...
To use dongcarl's substitute server for Tangerine Core builds after having
