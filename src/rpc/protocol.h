...
#ifndef TANGERINE_RPC_PROTOCOL_H
#define TANGERINE_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in tangerined
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Tangerine is not connected
...
#endif // TANGERINE_RPC_PROTOCOL_H
