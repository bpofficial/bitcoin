...
#ifndef TANGERINE_COMPAT_ASSUMPTIONS_H
#define TANGERINE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Tangerine cannot be compiled without assertions."
#endif
...
#endif // TANGERINE_COMPAT_ASSUMPTIONS_H
