...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const char* pszTimestamp = "Half a glass of orange juice, is more than none - 20/May/2021";
...
public:
    CMainParams()
    {
        ...
        //assert(consensus.hashGenesisBlock == uint256S("0x0000000083deb2a6ad5179d6da874351475ec39c2dd3f533f1d560e24850b567"));
        //assert(consensus.hashGenesisBlock == uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"));
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        //assert(genesis.hashMerkleRoot == uint256S("0x16fbfa211a45839c8acbf9368bf6bb8ccf63506872adc556123a7ad5c4e10f8f"));
        ...
        vSeeds.emplace_back("seed.tngcoin.net"); // Pieter Wuille, only supports x1, x5, x9, and xd
        // vSeeds.emplace_back("dnsseed.bluematt.me");           // Matt Corallo, only supports x9
        // vSeeds.emplace_back("dnsseed.tangerine.dashjr.org");    // Luke Dashjr
        // vSeeds.emplace_back("seed.tangerinestats.com");         // Christian Decker, supports x1 - xf
        // vSeeds.emplace_back("seed.tangerine.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        // vSeeds.emplace_back("seed.TNG.petertodd.org");        // Peter Todd, only supports x1, x5, x9, and xd
        // vSeeds.emplace_back("seed.tangerine.sprovoost.nl");     // Sjors Provoost
        // vSeeds.emplace_back("dnsseed.emzy.de");               // Stephan Oeste
        // vSeeds.emplace_back("seed.tangerine.wiz.biz");          // Jason Maurice
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("testnet-seed.tangerine.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tTNG.petertodd.org");
        vSeeds.emplace_back("seed.testnet.tangerine.sprovoost.nl");
...
public:
    explicit SigNetParams(const ArgsManager& args)
    {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("v7ajjeirttkbnt32wpy3c6w3emwnfr3fkla7hpxcfokr3ysd3kqtzmqd.onion:35113");
