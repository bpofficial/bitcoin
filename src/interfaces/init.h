...
#ifndef TANGERINE_INTERFACES_INIT_H
#define TANGERINE_INTERFACES_INIT_H
...
//! (tangerine-gui, tangerine-node, tangerine-wallet, tangerined, tangerine-qt) and each
...
#endif // TANGERINE_INTERFACES_INIT_H
