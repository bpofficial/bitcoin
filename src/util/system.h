 ...
 */
#ifndef TANGERINE_UTIL_SYSTEM_H
#define TANGERINE_UTIL_SYSTEM_H
...
extern const char * const TANGERINE_CONF_FILENAME;
extern const char * const TANGERINE_SETTINGS_FILENAME;
