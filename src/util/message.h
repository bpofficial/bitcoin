...
#ifndef TANGERINE_UTIL_MESSAGE_H
#define TANGERINE_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's tangerine address, it must refer to a public key.
...
#endif // TANGERINE_UTIL_MESSAGE_H
