...
#ifndef TANGERINE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define TANGERINE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // TANGERINE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
