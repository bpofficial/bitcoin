...
#ifndef TANGERINE_WALLET_ISMINE_H
#define TANGERINE_WALLET_ISMINE_H
 ...
 * https://github.com/tangerine/tangerine/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // TANGERINE_WALLET_ISMINE_H
