...
#ifndef TANGERINE_WALLET_WALLET_H
#define TANGERINE_WALLET_WALLET_H
...
public:
     ...
     * on this tangerine node, and set to 0 for transactions that were created
...
#endif // TANGERINE_WALLET_WALLET_H
