...
#ifndef TANGERINE_WALLET_SCRIPTPUBKEYMAN_H
#define TANGERINE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Tangerine Core wallet was originally a collection of unrelated private
...
#endif // TANGERINE_WALLET_SCRIPTPUBKEYMAN_H
