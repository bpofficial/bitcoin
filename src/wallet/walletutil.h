...
#ifndef TANGERINE_WALLET_WALLETUTIL_H
#define TANGERINE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! tangerine from opening the wallet, thinking it was newly created, and
...
#endif // TANGERINE_WALLET_WALLETUTIL_H
