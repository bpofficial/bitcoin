...
#ifndef TANGERINE_CRYPTO_CHACHA_POLY_AEAD_H
#define TANGERINE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@tangerine.
 *
 ...
 *
 * The chacha20-poly1305@tangerine combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@tangerine cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@tangerine are relatively fast in
...
#endif // TANGERINE_CRYPTO_CHACHA_POLY_AEAD_H
