...
{
    BOOST_CHECK(TestSplitHost("www.tangerinecore.org", "www.tangerinecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.tangerinecore.org]", "www.tangerinecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.tangerinecore.org:80", "www.tangerinecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.tangerinecore.org]:80", "www.tangerinecore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5113", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5113", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5113", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:5113", "::", 8333));
    BOOST_CHECK(TestSplitHost("::5113", "::8333", 0));
    BOOST_CHECK(TestSplitHost(":5113", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:5113", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5113", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5113", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
