...
#ifndef TANGERINE_TEST_SCRIPTNUM10_H
#define TANGERINE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Tangerine Core 0.10.0, for cross-comparison.
 */
public:
