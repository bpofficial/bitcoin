    ...
    platformStyle(_platformStyle)
{
    ...
    // normal tangerine address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying tangerine address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &TangerineAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
