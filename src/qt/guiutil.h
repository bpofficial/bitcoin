...
#ifndef TANGERINE_QT_GUIUTIL_H
#define TANGERINE_QT_GUIUTIL_H
...
/** Utility functions used by the Tangerine Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "tangerine:" URI into recipient object, return true on successful parsing
