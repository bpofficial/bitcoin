...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, TangerineGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &TangerineGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &TangerineGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &TangerineGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &TangerineGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &TangerineGUI::updateWalletStatus);
    connect(gui, &TangerineGUI::setPrivacy, walletView, &WalletView::setPrivacy);
