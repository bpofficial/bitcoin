...
//! Entry point for TangerineApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TangerineApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TangerineGUI tests.
void AppTests::guiTests(TangerineGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TangerineGUI::consoleShown, this, &AppTests::consoleTests);
