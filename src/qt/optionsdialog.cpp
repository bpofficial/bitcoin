    ...
    mapper(nullptr)
{
    ...
    ui->tangerineAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->tangerineAtStartup);
    ...
    ui->tangerineAtStartup->setToolTip(ui->tangerineAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->tangerineAtStartup->setText(ui->tangerineAtStartup->text().arg(PACKAGE_NAME));

    ui->openTangerineConfButton->setToolTip(ui->openTangerineConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new TangerineUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tangerineAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTangerineConfButton_clicked()
{
