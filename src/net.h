...
#ifndef TANGERINE_NET_H
#define TANGERINE_NET_H
 ...
 * src/qt/guiutil.cpp and src/tangerine-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Tangerine’s Peer-to-Peer Network")
