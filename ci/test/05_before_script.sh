...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Tangerine
else
  DOCKER_EXEC echo \> \$HOME/.tangerine
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/tangerine/tangerine/pull/18288#discussion_r433189350 for
  # details.
