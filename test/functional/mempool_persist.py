...
By default, tangerined will dump mempool on shutdown and
...
class MempoolPersistTest(TangerineTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent tangerined from writing mempool.dat to disk. Verify that `savemempool` fails")
