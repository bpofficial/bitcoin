...
Verify that a tangerined node can use an external signer command.
...
class RPCSignerTest(TangerineTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart tangerined with -signer=<cmd>',
