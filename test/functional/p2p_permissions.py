...
class P2PPermissionsTests(TangerineTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].tangerineconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].tangerineconf, 'w', encoding="utf8") as f:
            f.write(newText)
