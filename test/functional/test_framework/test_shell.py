...
class TestShell:
    """Wrapper Class for TangerineTestFramework.

    The TestShell class extends the TangerineTestFramework
    ...
    class __TestShell(TangerineTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by TangerineTestFramework child class.
            self.num_nodes = 1
