...
"""Verify that starting tangerine with -h works as expected."""

from test_framework.test_framework import TangerineTestFramework
from test_framework.util import assert_equal

class HelpTest(TangerineTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tangerine with -h for help text")
        ...
        self.log.info("Start tangerine with -version for version information")
        ...
        self.log.info("Start tangerined with -fakearg to make sure it does not start")
