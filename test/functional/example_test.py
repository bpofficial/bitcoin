...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TangerineTestFramework
    pass


class ExampleTest(TangerineTestFramework):
    # Each functional test is a subclass of the TangerineTestFramework class.
    ...
    def custom_method(self):
        ...
        TangerineTestFramework class so other tests can use it."""
