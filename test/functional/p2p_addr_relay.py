...
class AddrReceiver(P2PInterface):
    ...
    def on_addr(self, message):
        for addr in message.addrs:
            ...
            if not 5113 <= addr.port < 8343:
                raise AssertionError("Invalid addr.port of {} (5113-8342 expected)".format(addr.port))
...
class AddrTest(TangerineTestFramework):
    counter = 0
    ...
    def getaddr_tests(self):
        ...
        for i in range(1000):
            ...
            self.nodes[0].addpeeraddress(a, 5113)
