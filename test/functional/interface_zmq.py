...
class ZMQTest (TangerineTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        self.skip_if_no_tangerined_zmq()
    ...
    def test_sequence(self):
        ...
        [seq] = self.setup_zmq_test([("sequence", "tcp://127.0.0.1:25113")])
        self.disconnect_nodes(0, 1)
