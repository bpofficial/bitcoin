...
// tangerine includes.
#include <..\src\script\tangerineconsensus.h>
...
int main()
{
    std::cout << "tangerineconsensus version: " << tangerineconsensus_version() << std::endl;
    ...
    auto op0Result = tangerineconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, tangerineconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
